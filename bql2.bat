...
set RENDER_OPTIONS=-DFLAT_SPAN -DFLAT_NUKAGE1_COLOR=65 -DFLAT_SKY_COLOR=3 -DWAD_FILE=\"WIN2_DOOMQL2.WAD\" -DMAPWIDTH=480 -DNR_OF_COLORS=2
...
@set GLOBOBJS=%GLOBOBJS% i_qlv2.c
...
del ql\doomql2
rename ql\doom8088.out doomql2
