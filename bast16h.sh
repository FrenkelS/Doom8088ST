...
export RENDER_OPTIONS="-DFLAT_SPAN -DFLAT_NUKAGE1_COLOR=32 -DFLAT_SKY_COLOR=7 -DWAD_FILE=\"DOOMST16.WAD\" -DNR_OF_COLORS=16"
...
m68k-atari-mintelf-gcc -c i_vast16h.c $RENDER_OPTIONS -march=$CPU -Ofast -fomit-frame-pointer -fgcse-sm -fgcse-las -fipa-pta -mfastcall -flto -fwhole-program -funroll-all-loops -fira-loop-pressure -freorder-blocks-algorithm=simple -fno-tree-pre
...
#export GLOBOBJS+=" i_vast16h.c"
export GLOBOBJS+=" i_vast16h.o"
