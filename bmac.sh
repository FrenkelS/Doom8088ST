...
export RENDER_OPTIONS="-DFLAT_SPAN -DFLAT_NUKAGE1_COLOR=190 -DFLAT_SKY_COLOR=252 -DWAD_FILE=\"DOOMMAC.WAD\" -DMAPWIDTH=480 -DNR_OF_COLORS=2"
...
m68k-apple-macos-gcc -c p_mobj.c   $RENDER_OPTIONS -march=$CPU -Ofast -fomit-frame-pointer -fgcse-sm -flto -fwhole-program -funroll-loops -fira-loop-pressure -fno-tree-pre
m68k-apple-macos-gcc -c p_sight.c  $RENDER_OPTIONS -march=$CPU -Ofast -fomit-frame-pointer -fgcse-sm -flto -fwhole-program -funroll-loops -fira-loop-pressure -fno-tree-pre
m68k-apple-macos-gcc -c r_data.c   $RENDER_OPTIONS -march=$CPU -Ofast -fomit-frame-pointer -fgcse-sm -flto -fwhole-program -funroll-loops -fira-loop-pressure -fno-tree-pre
m68k-apple-macos-gcc -c r_draw.c   $RENDER_OPTIONS -march=$CPU -Ofast -fomit-frame-pointer -fgcse-sm -flto -fwhole-program -funroll-loops -fira-loop-pressure -fno-tree-pre
m68k-apple-macos-gcc -c r_plane.c  $RENDER_OPTIONS -march=$CPU -Ofast -fomit-frame-pointer -fgcse-sm -flto -fwhole-program -funroll-loops -fira-loop-pressure -fno-tree-pre
m68k-apple-macos-gcc -c tables.c   $RENDER_OPTIONS -march=$CPU -Ofast -fomit-frame-pointer -fgcse-sm -flto -fwhole-program -funroll-loops -fira-loop-pressure -fno-tree-pre
m68k-apple-macos-gcc -c w_wad.c    $RENDER_OPTIONS -march=$CPU -Ofast -fomit-frame-pointer -fgcse-sm -flto -fwhole-program -funroll-loops -fira-loop-pressure -fno-tree-pre
m68k-apple-macos-gcc -c z_zone.c   $RENDER_OPTIONS -march=$CPU -Ofast -fomit-frame-pointer -fgcse-sm -flto -fwhole-program -funroll-loops -fira-loop-pressure -fno-tree-pre

m68k-apple-macos-gcc -c i_mac.c $RENDER_OPTIONS -march=$CPU -Os -fomit-frame-pointer -funroll-loops -fira-loop-pressure -funsafe-loop-optimizations -freorder-blocks-algorithm=stc -fno-tree-pre
...
#export GLOBOBJS+=" i_mac.c"
export GLOBOBJS+=" i_mac.o"
#export GLOBOBJS+=" i_macv.c"
export GLOBOBJS+=" i_macv.o"
...
m68k-apple-macos-gcc $GLOBOBJS $CFLAGS $RENDER_OPTIONS -Wl,-gc-sections -o mac/$OUTPUT
Rez -t APPL --copy mac/DOOM8088.code.bin --cc mac/DOOM8088.dsk
